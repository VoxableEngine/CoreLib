...
function Engine:removeEntity(entity, removeChildren, newParent)
    if self.entities[entity.id] then
        ...
        if entity.id then
            ECS.Debug("Engine: Entity id: " .. entity.id)
        else
            ECS.Debug("Engine: Entity has not been added to any engine yet. (No entity.id)")
        end
